...
try {
  ...
  $mail->Username   = 'sofiya.trubinova8@yandex.ru'; // Логин на почте
  $mail->Password   = 'cyuksfpgfkkeeidr'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('sofiya.trubinova8@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('trubinovasofi@gmail.com');
